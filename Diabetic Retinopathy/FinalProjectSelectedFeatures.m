...
for i=1:length(cv)
    ...
    t = fitctree(cell2mat(xtrain(1,i)),cell2mat(ytrain(1,i)),'PredictorNames',{'MA0.5','MA0.6','MA0.7','MA0.8','MA0.9','MA1','EXU7','EXU8','DME','Year','Age'});
...
False_Negatives = 100-((confusionMatTest(2,1)/sum(confusionMatTest(2,1:2)))*100)
False_Positives = 100-((confusionMatTest(1,2)/sum(confusionMatTest(1,1:2)))*100)
